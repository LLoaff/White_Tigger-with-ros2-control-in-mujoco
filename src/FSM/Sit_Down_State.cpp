...
void Sit_Down_State::enter()
{
    ...
    _target_angle(1) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.fr_knee_joint;
    _target_angle(2) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.fr_thigh_joint;
    _target_angle(3) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.fl_hip_joint;
    _target_angle(4) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.fl_knee_joint;
    _target_angle(5) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.fl_thigh_joint;
    _target_angle(6) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.br_hip_joint;
    _target_angle(7) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.br_knee_joint;
    _target_angle(8) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.br_thigh_joint;
    _target_angle(9) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.bl_hip_joint;
    _target_angle(10) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.bl_knee_joint;
    _target_angle(11) = _fstate_ctrl->_ioros->_state.Angle_Initialization_Variable.bl_thigh_joint;

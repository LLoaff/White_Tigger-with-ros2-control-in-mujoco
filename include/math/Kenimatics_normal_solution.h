...
Eigen::Matrix<double,3,1> CalTau(
    int group,Eigen::Matrix<double,3,1> angle,Eigen::Matrix<double,3,1> w,Eigen::Matrix<double,3,3>Kp ,Eigen::Matrix<double,3,3>Kd,
    Eigen::Matrix<double,3,1> target_pos, Eigen::Matrix<double,3,1> target_speed,FrameType frame);

Eigen::Matrix<double,12,1> CalTaus(
    Eigen::Matrix<double,12,1> angle,Eigen::Matrix<double,12,1> w,Eigen::Matrix<double,3,3>Kp ,Eigen::Matrix<double,3,3>Kd,
    Eigen::Matrix<double,12,1> target_pos, Eigen::Matrix<double,12,1> target_speed,FrameType frame);

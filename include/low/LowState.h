...
{
  float fr_thigh_joint = -2.64;
  float fr_knee_joint = 0.98;
  float fr_hip_joint = -0.2;

  float fl_thigh_joint = -2.64;
  float fl_knee_joint = 0.98;
  float fl_hip_joint = 0.2;

  float br_thigh_joint = -2.64;
  float br_knee_joint = 0.98;
  float br_hip_joint = -0.2;

  float bl_thigh_joint = -2.64;
  float bl_knee_joint = 0.98;

...
{
    public:
        LowCmd(mjModel *model, mjData *data);
        void Update();
        ...
        void SetZeroD();
        void SetTau(Eigen::Matrix<double,12,1> tau);
        ...
        Eigen::Matrix<double,12,1> getInitialQ12();
        ~LowCmd();
    ...
    private:
            ...
            mjData *_mjdata;
            int _jointid[12*3];
            void PDController(int id , float q,float vel,float kp,float kd,float tau);
            void idInit();
